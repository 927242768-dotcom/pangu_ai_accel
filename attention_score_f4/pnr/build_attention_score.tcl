# PGL50H F4 Attention Score 独立构建脚本。
# 在本目录运行：
# D:/Pango/PDS_2022.2-SP6.4/bin/pds_shell.exe -file build_attention_score.tcl -project_name attention_score

set ip_root "../../ipcore/pangu_ddr3_x32/pangu_ddr3_x32"

add_design "../rtl/attention_score_core.v"
add_design "../rtl/attention_score_ctrl.v"
add_design "../rtl/attention_score_top.v"
...
compile -top_module attention_score_top
