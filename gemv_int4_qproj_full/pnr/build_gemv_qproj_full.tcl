# PGL50H layer0 q_proj 完整 M=896、K=896、group=64 Q28 Linear 构建脚本。
# 在本目录运行：
# D:/Pango/PDS_2022.2-SP6.4/bin/pds_shell.exe -file build_gemv_qproj_full.tcl -project_name gemv_qproj_full

set ip_root "../../ipcore/pangu_ddr3_x32/pangu_ddr3_x32"

add_design "../rtl/int8_dot16_pipe.v"
add_design "../rtl/gemv_qproj_full_core.v"
add_design "../rtl/gemv_qproj_full_ctrl.v"
add_design "../rtl/gemv_qproj_full_top.v"
...
compile -top_module gemv_qproj_full_top
