# PGL50H layer0 Attention 最终残差构建脚本。
# 在本目录运行：
...
add_design "../rtl/attention_residual_core.v"
add_design "../rtl/attention_residual_ctrl.v"
add_design "../rtl/attention_residual_top.v"
...
compile -top_module attention_residual_top
