...
// 盘古 Logos PGL50H layer0 Attention 最终残差验证顶层。
// 顶层端口和 DDR3 IP 层级保持与已验证工程一致，复用原有板级约束。
module attention_residual_top #(
...
attention_residual_ctrl #(
    .CTRL_ADDR_WIDTH (CTRL_ADDR_WIDTH),
    .CLKS_PER_BIT    (868)
) u_attention_residual_ctrl (
    .core_clk        (core_clk),
