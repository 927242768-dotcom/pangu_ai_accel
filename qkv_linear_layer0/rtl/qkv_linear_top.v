...
// 盘古 Logos PGL50H layer0 Q/K/V 完整真实 Linear 统一验证顶层。
// 顶层端口保持与已验证 DDR3 example design 一致，复用原有引脚和时序约束。
module qkv_linear_top #(
...
qkv_linear_ctrl #(
    ...
    .debug_projection(projection_select),
...
wire _unused_debug = &{1'b0, debug_data, debug_slice_state, debug_calib_ctrl,
                       ...
                       update_com_val_err_flag, ctrl_state, projection_select, loaded};
