# PGL50H layer0 MLP SiLU(gate) 构建脚本。
# 在本目录运行：
...
add_design "../rtl/mlp_silu_core.v"
add_design "../rtl/mlp_silu_ctrl.v"
add_design "../rtl/mlp_silu_top.v"
...
compile -top_module mlp_silu_top
synthesize -ads -selected_syn_tool_opt 2
dev_map
# 默认 PnR 种子在同一 DDR3 板级约束下已被 gate/up 工程验证；
# 首次显式 seed17/29 仅剩 0.015 ns Fast hold 违例，因此这里采用默认种子重跑。
