# PGL50H layer0 MLP down_proj M=896、K=4864、group=64 Q28 Linear 构建脚本。
# 在本目录运行：
...
add_design "../rtl/mlp_down_proj_core.v"
add_design "../rtl/mlp_down_proj_ctrl.v"
add_design "../rtl/mlp_down_proj_top.v"
...
compile -top_module mlp_down_proj_top
