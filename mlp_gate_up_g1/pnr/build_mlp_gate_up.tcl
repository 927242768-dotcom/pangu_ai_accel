# PGL50H layer0 MLP gate_proj/up_proj M=4864、K=896、group=64 构建脚本。
# 在本目录运行：
...
# 复用已经真实上板验证的 K=896 Q28 Linear 核，只替换 4864 行控制器和顶层。
add_design "../../gemv_int4_qproj_full/rtl/int8_dot16_pipe.v"
add_design "../../gemv_int4_qproj_full/rtl/gemv_qproj_full_core.v"
add_design "../rtl/mlp_gate_up_ctrl.v"
add_design "../rtl/mlp_gate_up_top.v"
...
compile -top_module mlp_gate_up_top
