# PGL50H F5 Softmax 独立构建脚本。
# 在本目录运行：
# D:/Pango/PDS_2022.2-SP6.4/bin/pds_shell.exe -file build_softmax.tcl -project_name softmax_f5

set ip_root "../../ipcore/pangu_ddr3_x32/pangu_ddr3_x32"

add_design "../rtl/softmax_core.v"
add_design "../rtl/softmax_ctrl.v"
add_design "../rtl/softmax_top.v"
...
compile -top_module softmax_top
