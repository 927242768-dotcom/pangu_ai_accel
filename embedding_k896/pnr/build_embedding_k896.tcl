# PGL50H tied Embedding K=896 构建脚本。
# 在本目录运行：
...
add_design "../rtl/embedding_k896_core.v"
add_design "../rtl/embedding_k896_ctrl.v"
add_design "../rtl/embedding_k896_top.v"
...
compile -top_module embedding_k896_top
