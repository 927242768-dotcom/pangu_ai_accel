# PGL50H F6 Attention 输出独立构建脚本。
# 在本目录运行：
# D:/Pango/PDS_2022.2-SP6.4/bin/pds_shell.exe -file build_attention_output.tcl -project_name attention_output

set ip_root "../../ipcore/pangu_ddr3_x32/pangu_ddr3_x32"

add_design "../rtl/attention_output_core.v"
add_design "../rtl/attention_output_ctrl.v"
add_design "../rtl/attention_output_top.v"
...
compile -top_module attention_output_top
