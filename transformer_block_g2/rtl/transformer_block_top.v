...
wire protocol_error;
wire configured;
wire payload_committed;
wire result_valid;
wire block_busy;
wire [4:0] block_stage;
wire [7:0] block_error_code;
...
assign heart_beat_led = result_valid ? 1'b1 :
                        (block_busy ? heartbeat :
                        (ddr_init_done ? heartbeat : 1'b0));
assign err_flag_led = protocol_error || (block_error_code != 8'd0);
...
wire _unused_debug = &{1'b0, debug_data, debug_slice_state,
    debug_calib_ctrl, ck_dly_set_bin, wl_step_ov_warning, dll_step,
    dll_lock, update_com_val_err_flag, host_state, configured,
    payload_committed, block_stage};
