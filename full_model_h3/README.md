...
- H3 host 已支持 `--check-reference`，仅接受完整 layer0..23、query/window/count=`0/0/1` 的冻结条件；未来板测将逐层回读 1,792 B output 并与软件 SHA256 比较。
- 直接受影响测试 `46/46 PASS`，完整回归 `244/244 PASS`，24 层冻结清单显式重算 verify PASS。
