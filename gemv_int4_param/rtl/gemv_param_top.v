...
// 盘古 Logos PGL50H 运行时参数化 packed INT4 GEMV 验证顶层。
// 顶层端口保持与已验证 DDR3 example design 一致，复用已上板引脚和时序约束。
module gemv_param_top #(
...
wire _unused_debug = &{1'b0, debug_data, debug_slice_state, debug_calib_ctrl,
                       ...
                       update_com_val_err_flag, ctrl_state, config_valid, loaded};
