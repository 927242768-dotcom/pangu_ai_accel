# PGL50H F6 layer0 Attention O_proj 独立 M=896、K=896、group=64 构建脚本。
# 在本目录运行：
# D:/Pango/PDS_2022.2-SP6.4/bin/pds_shell.exe -file build_attention_oproj.tcl -project_name attention_oproj

set ip_root "../../ipcore/pangu_ddr3_x32/pangu_ddr3_x32"

# 复用已经真实上板通过的完整 Linear RTL，不修改原 q_proj 工程。
add_design "../../gemv_int4_qproj_full/rtl/int8_dot16_pipe.v"
add_design "../../gemv_int4_qproj_full/rtl/gemv_qproj_full_core.v"
add_design "../../gemv_int4_qproj_full/rtl/gemv_qproj_full_ctrl.v"
add_design "../rtl/attention_oproj_top.v"
...
compile -top_module attention_oproj_top
