...
// 盘古 Logos PGL50H DDR3 + INT8 MAC16 集成验证顶层。
// 顶层端口名称保持与已上板通过的 DDR3 example design 一致，以复用同一套引脚约束。
module ddr_mac16_top #(
...
pangu_ddr3_x32 #(
    ...
    // 保持与已上板通过的官方 example design 相同的 PHY 调试默认值。
