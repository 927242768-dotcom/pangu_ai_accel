#!/usr/bin/env python3
"""F6 Attention 残差与完整 layer0 子层软件参考测试。"""
...
class AttentionResidualReferenceTests(unittest.TestCase):
    ...
    def test_q28_to_q10_saturation(self) -> None:
        ...
        converted, saturated = rescale_oproj_q28_to_q10(values)
    ...
    def test_residual_double_saturation(self) -> None:
        ...
        oproj[0] = 2 << RESCALE_SHIFT
        oproj[1] = -(2 << RESCALE_SHIFT)
        output, scaled, rescale_sat, add_sat = attention_residual_q10(hidden, oproj)
