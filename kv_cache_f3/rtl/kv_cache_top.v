...
// 盘古 Logos PGL50H F3 KV Cache 独立验证顶层。
...
assign heart_beat_led = (write_valid || read_valid) ? 1'b1 :
...
kv_cache_ctrl #(
    ...
    .debug_position   (current_position),
